function [thickness,radiusG,R_r,radial_average_G,radial_average_R,dRG,dRR,centroid,pxlSize,Ig,Ir]=funCoatThickness(data,idSlice,debug)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
GBW = bwareaopen(GBW,10000);%remove noise
...
rEstimate = sqrt(bwarea(RBWC)/pi)+50;
...
dRG = radiusG-radius*pxlSize;
dRR = radiusRBW*pxlSize - radiusR;
if debug
    figure(6)
 %   hold on
